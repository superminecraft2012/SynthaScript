      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#book-call" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Book a Call
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:hello@synthascript.com" className="text-gray-400 hover:text-white text-sm transition-colors">
                  hello@synthascript.com
                </a>
              </li>
              <li>
                <a href="#book-call" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Schedule a Call
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} SynthaScript. All rights reserved.
          </p>
